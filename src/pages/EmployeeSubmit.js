...
export default function EmployeeSubmit() {
  ...
  const init = async (e) => {
    // Only load tasks for this employee's section
    const sectionId = e.section_id || null
    const [t, sub] = await Promise.all([
      getTasks(e.org_id, sectionId),
  ...
  if (existing || submittedEntries) return (
    <div className="page">
      ...
      <div className="success-page">
        ...
        {sectionInfo && (
          <div className="badge badge-brand" style={{ fontSize: 14, padding: '6px 16px' }}>
