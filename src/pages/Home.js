...
export default function Home() {
  ...
  return (
    <div className="home-hero">
      ...
      <p className="home-sub">إدارة مهام الموظفين بسهولة — لكل مؤسسة رابط خاص بها</p>
      <div className="home-btns">
        <button className="home-btn emp" onClick={() => nav('/admin/login')}>
          <span className="home-btn-icon">👤</span>
          <div>
            <div className="home-btn-label">دخول الموظف</div>
            <div className="home-btn-hint">استخدم الرابط الخاص بمؤسستك</div>
          </div>
        </button>
