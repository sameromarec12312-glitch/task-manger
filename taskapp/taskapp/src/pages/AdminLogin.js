...
export default function AdminLogin() {
  ...
  const submit = async () => {
    ...
    setLoading(true)
    try {
      const org = await loginAdmin({ username, password })
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <p className="auth-sub">أدخل بياناتك للوصول إلى لوحة التحكم</p>
        ...
        <div className="link-text">
          ليس لديك حساب؟ <Link to="/admin/signup">إنشاء حساب</Link>
        </div>
      </div>
    </div>
  )
